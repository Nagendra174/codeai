...
const RealStories = () => {
  return (
<div
  className="flex max-xl:flex-col w-[97%] max-sm:mx-2 max-sm:w-screen mx-auto pt-10 px-10 my-10 rounded-[4rem] bg-[radial-gradient(ellipse_at_bottom,_#ffc590_0%,_#ffc590_15%,_#f0d4d9_40%,_#e0ecf9_60%,_#deeaf6_100%)]"
